!(function (e, t) {
    ...
    J = e => {
      ...
      for (const n in e)
        (t = n),
          ...
          e.toast && ((t = n), _.includes(t) && a('The parameter "'.concat(t, '" is incompatible with toasts'))),
          (t = n),
          Z(t) && N(t, Z(t));
      var t;
    };
  ...
  const Me = (e, t) => {
    ...
    i &&
      ...
      (o = i),
      (n = t.position) in p ? k(o, p[n]) : (a('The "position" parameter is not valid, defaulting to "center"'), k(o, p.center)),
      (n = i),
  ...
  const De = ['input', 'file', 'range', 'select', 'radio', 'checkbox', 'textarea'],
    ...
    Re =
        ...
        O.url =
          (e, t) => (
            'string' == typeof t.inputValue || 'number' == typeof t.inputValue
              ...
              : U(t.inputValue) ||
                a('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof t.inputValue, '"')),
            Ve(e, e, t),
            qe(e, t),
            (e.type = t.input),
            e
      ...
      (e, t) => {
        const n = $();
        C(n, t, 'htmlContainer'),
          t.html ? (Te(t.html, n), B(n, 'block')) : t.text ? ((n.textContent = t.text), B(n, 'block')) : x(n),
          He(e, t);
      }),
    Fe = (e, t) => {
      var n = te();
    ...
    We = (e, t) => {
      ...
      return e && t.icon === e.icon
        ...
        ? t.icon && -1 === Object.keys(o).indexOf(t.icon)
          ? (l('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.icon, '"')), x(n))
    ...
    Ze = (e, t) => {
      ...
      (e.textContent = ''),
        t.iconHtml
          ...
          : 'error' === t.icon
          ? v(e, Ye)
          : ((n = {question: '?', warning: '!', info: 'i'}), v(e, Xe(n[t.icon])));
    },
    Je = (e, t) => {
      if (t.iconColor) {
    ...
    et = (e, t) => {
      var n = m();
      const o = g();
      t.toast ? (pe(n, 'width', t.width), (o.style.width = '100%'), o.insertBefore(d(), s())) : pe(o, 'width', t.width),
      ...
      ((n.className = ''.concat(p.popup, ' ').concat(E(n) ? t.showClass.popup : '')), t.toast)
        ? (k([document.documentElement, document.body], p['toast-shown']), k(n, p.toast))
        : k(n, p.modal);
  ...
  const ht = () => {
      null === c.previousBodyPadding &&
        ...
        ((c.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue('padding-right'))),
    ...
    ft = () => {
      null !== c.previousBodyPadding &&
        ((document.body.style.paddingRight = ''.concat(c.previousBodyPadding, 'px')), (c.previousBodyPadding = null));
    },
    bt = () => {
      if (
    ...
    yt = e => {
      ...
      return (
        ...
        (n === o || !(fe(o) || 'INPUT' === n.tagName || 'TEXTAREA' === n.tagName || (fe($()) && $().contains(n))))
      );
    },
    vt = () => {
      var e;
  ...
  e = Object.freeze({
    ...
    _destroy: function () {
      ...
      t
        ? (e.popup && T.swalCloseEventFinishedCallback && (T.swalCloseEventFinishedCallback(), delete T.swalCloseEventFinishedCallback),
  ...
  const Ft = (e, t) => {
      ...
      if (n.inputValidator) {
        ...
        e.getInput().checkValidity() ? ('deny' === t ? Ut : _t)(e, o) : (e.enableButtons(), e.showValidationMessage(n.validationMessage));
    },
    Ut = (t, n) => {
      ...
      if ((e.showLoaderOnDeny && D(f()), e.preDeny)) {
        ...
        o.then(e => {
          !1 === e ? (t.hideLoading(), Dt(t)) : t.closePopup({isDenied: !0, value: void 0 === e ? n : e});
    ...
    Kt = (n, e, o) => {
      e.popup.onclick = () => {
        ...
        (t && ((e = t).showConfirmButton || e.showDenyButton || e.showCancelButton || e.showCloseButton || t.timer || t.input)) ||
          o(j.close);
      };
    };
  let Yt = !1;
        ...
        if ((o.stopKeydownPropagation && n.stopPropagation(), 'Enter' === n.key))
          (e = e),
            ...
            R(i.allowEnterKey) &&
              ...
              (['textarea', 'file'].includes(i.input) || ($t(), s.preventDefault()));
        else if ('Tab' === n.key) {
          e = n;
          var i = o;
          var a = e.target,
    ...
    constructor() {
      if ('undefined' != typeof window) {
        ...
        var o = Object.freeze(this.constructor.argsToParams(t)),
          o =
            (Object.defineProperties(this, {params: {value: o, writable: !1, enumerable: !0, configurable: !0}}), this._main(this.params));
  ...
  const pn = (l, u, d) =>
      new Promise((e, t) => {
        ...
        Ot.swalPromiseResolve.set(l, e),
          ...
          (t = u),
          (a = n),
          L.innerParams.get(e).toast ? Kt(e, t, a) : (Zt(t), Jt(t), Xt(e, t, a)),
          (o = l),
          (e = T),
          (t = d),
          (i = n),
